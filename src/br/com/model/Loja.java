...
public class Loja {
   ...
   for (Livro livro : livros) {
	   System.out.println("Título: " + livro.getNome()+ ", Preco: " + livro.getPreco () + ", Quantidade disponível: " + livro.getQuantidade() + ", Autor: " +livro.getAutor() + ", Tema: " +livro.getTema() + ",Numero de páginas: " +livro.getQtdPag() );
   ...
   public void listVideoGame() { 
	   ...
	   for (VideoGame game : games) 
		System.out.println("Título: " + game.getNome() + ", Preço: " + game.getPreco() + ", Quantidade disponivel:" + game.getQuantidade() + ", Marca: " + game.getMarca() + ", Modelo: " + game.getModelo() + ", Usado: " + game.isUsado() );
